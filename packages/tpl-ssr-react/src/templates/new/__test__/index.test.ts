...
describe('[tpl-ssr-react]: component_class template test', function () {
  it('type checking', function () {
    expect(component_class).to.be.a('function');
  });
});

describe('[tpl-ssr-react]: component_function template test', function () {
  it('type checking', function () {
    expect(component_function).to.be.a('function');
  });
});

describe('[tpl-ssr-react]: component_index template test', function () {
  it('type checking', function () {
...
describe('[tpl-ssr-react]: component_stylesheet template test', function () {
  it('type checking', function () {
    expect(component_stylesheet).to.be.a('function');
  });
});

describe('[tpl-ssr-react]: component_test template test', function () {
  it('type checking', function () {
