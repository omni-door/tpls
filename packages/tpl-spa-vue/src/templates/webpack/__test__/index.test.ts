...
describe('[tpl-spa-vue]: config_common template test', function () {
  it('type checking', function () {
    expect(config_common).to.be.a('function');
  });
});

describe('[tpl-spa-vue]: config_dev template test', function () {
  it('type checking', function () {
    expect(config_dev).to.be.a('function');
  });
});

describe('[tpl-spa-vue]: config_prod template test', function () {
  it('type checking', function () {
