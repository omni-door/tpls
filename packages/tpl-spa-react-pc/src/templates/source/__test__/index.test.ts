...
describe('[tpl-spa-react-pc]: source_declaration_index template test', function () {
  it('type checking', function () {
    expect(source_declaration_index).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_declaration_global template test', function () {
  it('type checking', function () {
    expect(source_declaration_global).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_html template test', function () {
  it('type checking', function () {
    expect(source_html).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_index_react template test', function () {
  it('type checking', function () {
    expect(source_index_react).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_index_style template test', function () {
  it('type checking', function () {
    expect(source_index_style).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_index_reset template test', function () {
  it('type checking', function () {
    expect(source_index_reset).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_index_routes template test', function () {
  it('type checking', function () {
    expect(source_index_routes).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_page_index template test', function () {
  it('type checking', function () {
    expect(source_page_index).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_page_page template test', function () {
  it('type checking', function () {
    expect(source_page_page).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_page_page_nest template test', function () {
  it('type checking', function () {
    expect(source_page_page_nest).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_page_style template test', function () {
  it('type checking', function () {
    expect(source_page_style).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_component_index template test', function () {
  it('type checking', function () {
    expect(source_component_index).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_component_cp template test', function () {
  it('type checking', function () {
    expect(source_component_cp).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_component_style template test', function () {
  it('type checking', function () {
    expect(source_component_style).to.be.a('function');
  });
});

describe('[tpl-spa-react-pc]: source_component_test template test', function () {
  it('type checking', function () {
