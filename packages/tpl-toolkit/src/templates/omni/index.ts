import { tplEngineInit, BUILD } from '@omni-door/utils';
...
module.exports = {
  ...
  build: {
    ...
    // Build tool; supports tsc and rollup.
    tool: '\${build}', 
    ...
    reserve: {
      assets: [] // Preserve asset paths in the build output.
    },
...
export default (build: BUILD) => tplEngineInit(tpl_omni, 'tpl', { build });